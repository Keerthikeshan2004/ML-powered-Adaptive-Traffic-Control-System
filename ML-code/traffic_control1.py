...
ACCOUNT_SID = "AC12a2f53690771be84e429c69af5427ae"
AUTH_TOKEN = "eb002f793ffffe2d3c35e960ea68ab5e"
TWILIO_PHONE = "+19162329838"
...
def start_main_program():
    ...
    # Load video sources
    video_paths = [
        "object detection project/traffic6.mp4",
        "object detection project/traffic8.mp4",
        "object detection project/traffic3.mp4",
        "object detection project/traffic4.mp4"
    ]
    caps = [cv2.VideoCapture(path) for path in video_paths]

    # Load YOLO model
    model = YOLO('.cvlib/object_detection/yolo/yolov3/yolov8n.pt')
    
    vehicle_classes = {"car", "truck", "motorbike", "bus","person","bicycle"}
    ...
    while True:
            ...
            if i != current_video:
                ...
                for r in results:
                    for box in r.boxes:
                        ...
                        if currentClass in emergency_classes and conf > 0.3:
        ...
        if emergency_detected:
            current_video = 0  # Override to first junction
            time_left = 10  # Provide a green signal for at least 10 seconds
...
title_label = tk.Label(
    ...
    font=("Arial", 28, "bold"),
    fg="#FFD700",  # Gold color for a stylish look
    bg="#282C35"
)
title_label.pack(pady=50)  # Add more spacing for a clean look

# Frame to center the start button
button_frame = tk.Frame(welcome_window, bg="#282C35")
button_frame.pack(expand=True)  # Expands to center the button
...
start_button.pack()  # Centers the button inside the frame
